...
public class EnderecoController {
    ...
    private ResponseEntity<Endereco> create(@RequestBody CEPDTO cepdto){
        ...
        if(!bairroOpt.isPresent()){
            ...
            bairroOpt = bairroRepository.findByNome(body.getBairro());
        }
        ...
        if(!logradouroOpt.isPresent()){
            ...
            logradouroOpt = logradouroRepository.findByNome(body.getLogradouro());
        }
        ...
        if(!ufOpt.isPresent()){
            ...
            ufOpt = unidadeFederacaoRepository.findByNome(body.getUf());
        }
        ...
        if(!cidadeOpt.isPresent()){
            ...
            cidadeOpt = cidadeRepository.findByNome(body.getLocalidade());
        }
